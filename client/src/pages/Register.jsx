...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      userdata.append("firstName", inputs.firstName);
      userdata.append("lastName", inputs.lastName);
      userdata.append("email", inputs.email);
      userdata.append("password", inputs.password);
      userdata.append("image", inputs.image);
    ...
    <div className="pb-8">
      ...
      <div className="lg:flex">
        <div className="lg:w-1/2 xl:max-w-screen-sm">
          <div className="lg:bg-white flex justify-center lg:justify-start lg:px-12"></div>
