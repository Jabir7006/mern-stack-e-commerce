    ...
    <section className="bg-gray-100 dark:bg-gray-900 py-8 lg:py-16 antialiased pt-24 mt-12 px-3 lg:px-8 relative">
      {loading && (
        <div
          ...
          className="h-full w-full absolute top-0 left-0 flex justify-center items-center bg-black bg-opacity-50 z-[9999]"
        >
          <div
          ...
          >
            <div
              ...
              className="inline-block h-8 w-8 animate-spin border-transparent motion-reduce:animate-[spin_1.5s_linear_infinite] text-white"
              role="status"
            >
            ...
            <span data-te-loading-text-ref className="text-white">
              Loading...
            </span>
          </div>
        </div>
